...
let user = {
	...
	gender: 'Male',
	imageUrl:
		'https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Duck_%2827479065157%29.jpg/640px-Duck_%2827479065157%29.jpg',
	college: 'Warren',
	...
	lifestyle: {
		...
		hobbies: ['Reading', 'Walking', 'Birdwatching'],
	},
	propPref: {
		budget: [0, 1000],
		distance: [0, 15],
...
let users = Array.from({ length: 20 }, (_) => user);
